...
AddEventHandler("vRP:playerActive",function(user_id,name)
	...
	SetDiscordAppId(987808178362261634)
	SetDiscordRichPresenceAsset("underground")
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("underground")
	SetDiscordRichPresenceAssetText("Underground Roleplay")
	SetDiscordRichPresenceAssetSmallText("Creative Roleplay")
	SetDiscordRichPresenceAction(0,"Discord","https://images-wixmp-530a50041672c69d335ba4cf.wixmp.com/templates/image/d6affcc8447a296e430066f89e19ad1ae695722dd417f867e10fe199967b5bfd.jpg")
	SetDiscordRichPresenceAction(1,"Instagram","https://images-wixmp-530a50041672c69d335ba4cf.wixmp.com/templates/image/d6affcc8447a296e430066f89e19ad1ae695722dd417f867e10fe199967b5bfd.jpg")
