...
AddEventHandler("vRP:playerActive",function(user_id,name)
	...
	SetDiscordAppId(878263742268317756)
	SetDiscordRichPresenceAsset("imgunderground")
	SetRichPresence("#"..user_id.." "..name)
	SetDiscordRichPresenceAssetSmall("imgunderground")
	SetDiscordRichPresenceAssetText("Underground")
	SetDiscordRichPresenceAssetSmallText("Underground")
