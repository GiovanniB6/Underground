...
local works = {
	...
	["Lifeguard"] = {
        ["coords"] = { -1447.42,-1043.52,4.8 },
		["upgradeStress"] = 0.05,
		["routeCollect"] = true,
		["routeDelivery"] = false,
		["deliveryVehicle"] = -48031959,
		["usingVehicle"] = true,
		["collectRandom"] = false,
		["collectButtonDistance"] = 1,
		["collectShowDistance"] = 500,
        ...
        ["collectCoords"] = {
            { -1453.43,-1032.44,4.4 },
            { -1478.51,-1067.69,3.34 },
            { -1551.46,-1042.35,6.28 },
            { -1646.45,-964.86,7.19 },
            { -1721.44,-888.87,7.38 },
            { -1720.76,-762.01,9.69 },
            { -1885.49,-619.92,11.04 },
            { -1985.85,-539.12,11.17 },
            { -1928.17,-642.89,10.01 },
            { -1805.22,-801.52,7.4 },
            { -1739.27,-942.07,7.28 },
            { -1733.44,-1012.11,3.66 },
            { -1655.68,-1096.73,0.98 },
            { -1571.9,-1181.9,1.48 },
            { -1511.47,-1270.28,1.62 },
            { -1467.21,-1427.09,1.65 },
            { -1419.32,-1518.98,1.89 },
            { -1363.97,-1626.84,1.67 },
            { -1280.37,-1754.22,1.7 },
            { -1220.84,-1765.54,2.51 },
            { -1159.7,-1756.07,3.5 },
            { -1092.36,-1705.43,3.79 },
            { -1161.59,-1599.07,3.84 },
            { -1225.46,-1515.96,3.77 },
            { -1296.46,-1402.95,3.89 },
            { -1343.22,-1276.31,4.4 },
            { -1361.69,-1123.63,3.76 },
            { -1414.23,-1038.17,4.13 }
        },
